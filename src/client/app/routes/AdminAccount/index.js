					...
					<Row>
						<Col md={2} sm={2} xs={12}>
							...
							{/* <ListGroupItem disabled tag="a" href="#">Cras justo odio</ListGroupItem> */}
								...
								<ListGroupItem name='content' className={ active === navigationIndexer.content ? 'active-menu' : '' } tag="a" href="#" onClick={this.handleSwitch}>
									<FontAwesome name="file-text"/> About, Help, T&C
								</ListGroupItem>
							</ListGroup>
						</Col>
